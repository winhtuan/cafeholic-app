...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccId).HasName("PK__Account__91CBC398B5105E21");
        ...
        {
            entity.HasKey(e => e.DrinkId).HasName("PK__Drink__C094D3E82B35E672");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menu__C99ED230840C702C");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__C3905BCF01169BBB");
        ...
        {
            entity.HasKey(e => e.OrderItemId).HasName("PK__OrderIte__57ED068182EA8705");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Password__3214EC07FC1D74EC");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__9B556A38FB4219E6");
        ...
        {
            entity.HasKey(e => e.ReservationId).HasName("PK__Reservat__B7EE5F24BFFD54A4");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Review__74BC79CE07D697B0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Role__3214EC0754B45987");
        ...
        {
            entity.HasKey(e => e.TypeId).HasName("PK__RoomType__516F03B572E120AD");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__StudyRoo__3286393945E87FEC");
        ...
        {
            entity.HasKey(e => e.SuggestionId).HasName("PK__Suggesti__9409950802AA5822");
            ...
            entity.HasMany(d => d.Drinks).WithMany(p => p.Suggestions)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("SuggestionId", "DrinkId").HasName("PK__Suggesti__0800D836B9513F26");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A6B2E60E202");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__User__3214EC0781B82B7E");
        ...
        {
            entity.HasKey(e => e.VoucherId).HasName("PK__Voucher__3AEE7921B2AAE276");
